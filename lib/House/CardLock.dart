...
class MyCardLock extends StatelessWidget {
  final databaseReference = FirebaseDatabase.instance.ref();
  final String lockId;
  final bool state;
  final String houseId;

  MyCardLock(this.lockId, this.state, this.houseId);
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      onLongPress: () {
        showDialog(context: context, builder: (BuildContext context) {
          return AlertDialog(
            title: Text('Delete Lock'),
            content: Text('Are you sure you want to delete it: $lockId'),
            actions: <Widget>[
              TextButton(
                onPressed: () {
                  Navigator.of(context).pop();
